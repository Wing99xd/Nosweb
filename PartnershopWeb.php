        ...
        <div class="shop-container">
            ...
            <div class="product-grid">
                ...
                <div class="product-card">
                    <img src="shopimages/4413.webp" alt="Amora Partner Card (Clean)">
                    <b>Amora Partner Card (Clean)</b>
                    <p>Price: 200 Coins</p>
                    <button>Buy</button>
                </div>
                <!-- Product 2 -->
                <div class="product-card">
                    <img src="shopimages/4810.webp" alt="Hongbi Partner Card (Clean)">
                    <b>Hongbi Partner Card (Clean)</b>
                    <p>Price: 200 Coins</p>
                    <button>Buy</button>
                </div>
                <!-- Product 3 -->
                <div class="product-card">
                    <img src="shopimages/4405.webp" alt="Yuna's Specialist Partner Card (Clean)">
                    <b>Yuna's Specialist Partner Card (Clean)</b>
                    <p>Price: 200 Coins</p>
                    <button>Buy</button>
                </div>
                <!-- Product 4 -->
                <div class="product-card">
                    <img src="shopimages/4324.webp" alt="Guardian Lucifer Partner Card (Clean)">
                    <b>Guardian Lucifer Partner Card (Clean)</b>
                    <p>Price: 200 Coins</p>
                    <button>Buy</button>
                </div>

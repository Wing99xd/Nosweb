        ...
        <div class="shop-container">
            ...
            <div class="product-grid">
                ...
                <div class="product-card">
                    <img src="shopimages/4713.webp" alt="Fernon (Fire)">
                    <b>Fernon (Fire)</b>
                    <p>Price: 100 Coins</p>
                    <button>Buy</button>
                </div>
                <!-- Product 2 -->
                <div class="product-card">
                    <img src="shopimages/4714.webp" alt="Fernon (Water)">
                    <b>Fernon (Water)</b>
                    <p>Price: 100 Coins</p>
                    <button>Buy</button>
                </div>
                <!-- Product 3 -->
                <div class="product-card">
                    <img src="shopimages/4715.webp" alt="Fernon (Light)">
                    <b>Fernon (Light)</b>
                    <p>Price: 100 Coins</p>
                    <button>Buy</button>
                </div>
                <!-- Product 4 -->
                <div class="product-card">
                    <img src="shopimages/4716.webp" alt="Fernon (Shadow)">
                    <b>Fernon (Shadow)</b>
                    <p>Price: 100 Coins</p>
                    <button>Buy</button>
                </div>
